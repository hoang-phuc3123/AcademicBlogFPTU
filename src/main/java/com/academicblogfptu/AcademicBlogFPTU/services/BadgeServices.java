...
public class BadgeServices {
    ...
    public  void changeUserRoleBadge(UserEntity user,String roleBefore){
        ...
        UserBadgeEntity badgeBefore = userBadgeRepository.findByUserIdAndBadgeName(user.getId(), roleBefore).orElseThrow(()-> new AppException("Unknown user badge!!",HttpStatus.NOT_FOUND));

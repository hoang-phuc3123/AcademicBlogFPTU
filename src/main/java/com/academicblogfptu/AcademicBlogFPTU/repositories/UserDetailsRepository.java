...
public interface UserDetailsRepository extends JpaRepository<UserDetailsEntity, Integer> {
    ...
    @Query("SELECT ue.id, ue.username, ue.password, ude.fullName, ude.email, ude.phone, ue.role, ude.isBanned, ude.isMuted FROM UserDetailsEntity ude JOIN ude.user ue")
